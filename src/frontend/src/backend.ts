...
import type { ExternalBlob as _ExternalBlob, PostType as _PostType, UserProfile as _UserProfile, UserRole as _UserRole, Video as _Video, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async doubleTapToLike(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.doubleTapToLike(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPosts(): Promise<Array<[string, PostType]>> {
        if (this.processError) {
            try {
    ...
    async getFollowerCounts(arg0: Principal): Promise<FollowerCounts> {
        if (this.processError) {
            try {
                const result = await this.actor.getFollowerCounts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLikes(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getPostType(arg0: string): Promise<PostType | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPostType(arg0);
    ...
    async getReactionCounts(arg0: string): Promise<Array<ReactionCount>> {
        if (this.processError) {
            try {
    ...
    async getTrending(): Promise<Array<Video>> {
        if (this.processError) {
            try {
    ...
    async getVideo(arg0: string): Promise<Video> {
        if (this.processError) {
            try {
                ...
                return from_candid_Video_n19(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async registerPost(arg0: string, arg1: PostType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerPost(arg0, to_candid_PostType_n22(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideo(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(arg0, await to_candid_ExternalBlob_n24(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PostType_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostType): PostType {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PostType]): PostType | null {
    return value.length === 0 ? null : from_candid_PostType_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        url: await from_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.url),
        title: value.title,
        likes: value.likes,
...
function from_candid_tuple_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _PostType]): [string, PostType] {
    return [
        value[0],
        from_candid_PostType_n12(_uploadFile, _downloadFile, value[1])
    ];
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _PostType]>): Array<[string, PostType]> {
