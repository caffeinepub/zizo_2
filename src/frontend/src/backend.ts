...
export class Backend implements backendInterface {
    ...
    async uploadVideo(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadVideo(arg0, await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        url: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.url),
        title: value.title,
        likes: value.likes,
